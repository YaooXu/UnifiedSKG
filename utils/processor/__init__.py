...
"""
from .table_linearize import IndexedRowTableLinearize, TableGraphLinearize
...
def get_custom_processor(tokenizer, max_cell_length, max_input_length):
    table_linearize_func = TableGraphLinearize(tokenizer)
    table_truncate_funcs = [
        CellLimitTruncate(max_cell_length=max_cell_length,
                          tokenizer=tokenizer,
                          max_input_length=max_input_length),
    ...
    processor = TableProcessor(
        table_linearize_func=table_linearize_func,
        table_truncate_funcs=table_truncate_funcs)
    return processor
